...
// Sidebar Icons
export const HomeIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const HomeActiveIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const UserGroupIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const UserGroupActiveIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const DiscoverIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        fill="currentColor"
        width={width}
...
export const DiscoverActiveIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        fill="currentColor"
        width={width}
...
export const LiveIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const LiveActiveIcon = ({ className, width = '1.9rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
