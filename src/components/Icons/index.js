...
export const UploadIcon = ({ className, width = '1.4rem', height = '1.4rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const AppForPCIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const LaptopIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
...
export const MessageIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const NotifycationIcon = ({ className, width = '1.8rem', height = '1.8rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
